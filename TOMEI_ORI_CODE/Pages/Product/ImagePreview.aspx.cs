...
public partial class Pages_Product_ImagePreview : System.Web.UI.Page
{
    String ID = "";
    ...
    protected bool uploadtoDB()
    {
        ...
        f_Param[0] = new SqlParameter("@SeriesImage", System.Data.SqlDbType.Image);
        ...
        f_Param[4].Value = ID;
        int f_updated = f_DBEngine.Query("S_UpdateProductSeriesImage", f_Param);
        if (f_updated == 1)
        {
            f_result = true;
        }
