...
<asp:Content ID="Content" ContentPlaceHolderID="ContentPlaceHolderM" Runat="Server">
    ...
    <input id="txthidfield" type="hidden" runat="server" value="" />
...
&nbsp;<dxe:ASPxComboBox ID="ddlProductSeries" runat="server" 
       EnableViewState="True" EnableIncrementalFiltering="True"  onselectedindexchanged="ddlProductSeries_SelectedIndexChanged"   AutoPostBack="false"  PopupVerticalAlign="BottomSides" PopupHorizontalAlign="OutsideRight"
       >
    </dxe:ASPxComboBox>

    <script type="text/javascript">
        var objcode = document.body.innerHTML;

        var hdnDDLProdSeries = document.getElementById("ddlProdSeries_Hid");
        hdnDDLProdSeries.value = objcode;
    </script>
    <input id="ddlProdSeries_Hid" type="hidden" runat="server" value="" />
    ...
    KeyFieldName="GUID">
        ...
        <Columns>
            ...
            <%--<dxwgv:GridViewDataTextColumn FieldName="GUID" VisibleIndex="17" Visible="true">
            </dxwgv:GridViewDataTextColumn>--%>
        </Columns>
